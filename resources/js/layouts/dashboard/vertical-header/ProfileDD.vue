...
<template>
  ...
  <div>
    <div class="d-flex align-center pa-5">
      ...
      <div class="ml-auto">
        <v-btn variant="text" color="primary" rounded="sm" icon size="large" @click="store.dispatch('auth/logout')">
      ...
      <v-window v-model="tab">
        <v-window-item value="111">
          <v-list class="py-0" aria-label="profile list" aria-busy="true">
            ...
            <v-list-item @click="store.dispatch('auth/logout')" color="secondary" rounded="0">
              <template v-slot:prepend>
